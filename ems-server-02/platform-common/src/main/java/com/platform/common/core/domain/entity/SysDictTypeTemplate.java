 ...
 */
public class SysDictTypeTemplate extends BaseEntity {
    ...
    public SysDictTypeTemplate() {

    }

    public SysDictTypeTemplate(String dictName, String dictType, String status, String remark) {
