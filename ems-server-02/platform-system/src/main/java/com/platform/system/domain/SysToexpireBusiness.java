...
/**
 * 即将到期预警列对象 s_sys_toexpire_business
 *
 * @author linhongwei
 * @date 2021-06-29
 */
...
@ApiModel
@TableName(value = "s_sys_toexpire_business")
@JsonInclude(JsonInclude.Include.NON_NULL)
@Document
public class SysToexpireBusiness extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "即将到期业务通知sid")
    private Long toexpireBusinessSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] toexpireBusinessSidList;
    /**
