...
public interface SysDictDataMapper extends BaseMapper<SysDictData>
{
     ...
     * @return 字典数据集合信息
     */
    public List<SysDictData> selectDictDataListByJingque(SysDictData dictData);

    List<DictData>  getDictDataList();

    List<DictData>  getDictDataPrtvateList(String clientId);

    List<SysDictData> verify(SysDictData params);

    public List<SysDictData> selectPublicDictDataByType(String dictType);

    public List<SysDictData> selectPrivateDictDataByType(@Param("dictType") String dictType, @Param("clientId") String clientId);
