...
@ApiModel
@TableName(value = "s_pur_inquiry_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PurInquiryItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-物料询价单明细信息")
    private Long inquiryItemSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] inquiryItemSidList;
    /**
     * 系统SID-物料询价单号
     */
    @Excel(name = "系统SID-物料询价单号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-物料询价单号")
