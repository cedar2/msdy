...
/**
 * 财务流水账-明细-供应商调账对象 s_fin_book_vendor_account_adjust_item
 *
 * @author linhongwei
 * @date 2021-06-02
 */
...
@ApiModel
@TableName(value = "s_fin_book_vendor_account_adjust_item")
public class FinBookVendorAccountAdjustItem extends EmsBaseEntity implements Serializable {
