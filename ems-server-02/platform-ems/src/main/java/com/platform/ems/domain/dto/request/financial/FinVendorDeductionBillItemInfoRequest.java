...
/**
 * 供应商扣款单明细详情查询请求实体 FinVendorDeductionBillItemInfoRequest
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
@ApiModel
public class FinVendorDeductionBillItemInfoRequest extends EmsBaseEntity implements Serializable {
