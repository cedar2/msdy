...
/**
 * 财务状况-客户-待预收对象 s_rep_finance_status_daiys
 *
 * @author chenkw
 * @date 2022-02-25
 */
...
@ApiModel
@TableName(value = "s_rep_finance_status_daiys")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RepFinanceStatusDaiys extends EmsBaseEntity {
     ...
     */
    @Excel(name = "待预收金额")
    @ApiModelProperty(value = "待预收金额")
    private BigDecimal moneyAmountDaiys;
