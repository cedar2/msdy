...
/**
 * 物料检测问题台账对象 s_qua_rawmat_check_record
 *
 * @author admin
 * @date 2024-03-06
 */
...
@ApiModel
@TableName(value = "s_qua_rawmat_check_record")
public class QuaRawmatCheckRecord extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-物料检测记录")
    private Long rawmatCheckRecordSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] rawmatCheckRecordSidList;
    ...
    @Excel(name = "记录编号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "物料检测记录编号")
    private Long rawmatCheckRecordCode;
    ...
    private List<QuaRawmatCheckRecordAttach> attachmentList;
