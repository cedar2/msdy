...
/**
 * 客户互抵单详情返回实体 FinCustomerAccountBalanceBillInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
public class FinCustomerAccountBalanceBillInfoResponse extends EmsBaseEntity implements Serializable {
    ...
    private List<FinCustomerAccountBalanceBillItemInfoResponse> itemList;
