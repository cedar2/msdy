...
/**
 * 客户返修台账-明细对象 s_inv_record_customer_repair_item
 *
 * @author linhongwei
 * @date 2021-10-27
 */
...
@ApiModel
@TableName(value = "s_inv_record_customer_repair_item")
//@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvRecordCustomerRepairItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-客户返修台账明细")
    private Long customerRepairItemSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] customerRepairItemSidList;
    /**
     * 系统SID-客户返修台账
     */
