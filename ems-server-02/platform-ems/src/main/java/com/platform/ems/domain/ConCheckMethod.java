...
@ApiModel
@TableName(value = "s_con_check_method")
public class ConCheckMethod extends EmsBaseEntity {
	...
	@ApiModelProperty(value = "系统SID-检测方法sid")
	private Long sid;
	...
	@Excel(name = "启用/停用", dictType = "s_valid_flag",sort = 4)
