...
@ApiModel
@TableName(value = "s_inv_good_receipt_note")
//@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvGoodReceiptNote extends EmsBaseEntity{
    ...
    private Long[] goodReceiptNoteSidList;
    /**
     * 单据日期
     */
    ...
    @Valid
    @TableField(exist = false)
    private List<InvGoodReceiptNoteItem> listInvGoodReceiptNoteItem;

    @TableField(exist = false)
    private List<InvGoodReceiptNoteAttachment> listInvGoodReceiptNoteAttachment;
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    private Long[] creatorAccountList;
