...
/**
 * 客户押金对象 s_fin_customer_cash_pledge_bill
 *
 * @author chenkw
 * @date 2021-09-22
 */
...
@ApiModel
@TableName(value = "s_fin_customer_cash_pledge_bill")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinCustomerCashPledgeBill extends EmsBaseEntity {
    ...
    private List<FinCustomerCashPledgeBillItem> itemList;

    @TableField(exist = false)
    @Valid
    @ApiModelProperty(value = "押金附件表")
    private List<FinCustomerCashPledgeBillAttach> attachmentList;
