...
/**
 * 成衣检测单-检测项目对象 s_qua_product_check_item
 *
 * @author linhongwei
 * @date 2022-04-13
 */
...
@ApiModel
@TableName(value = "s_qua_product_check_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class QuaProductCheckItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-成衣检测单-检测项目")
    private Long productCheckItemSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] productCheckItemSidList;
    /**
     * 系统SID-成衣检测单
     */
