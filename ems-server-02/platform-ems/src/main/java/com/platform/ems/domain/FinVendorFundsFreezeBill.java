...
/**
 * 供应商暂押款对象 s_fin_vendor_funds_freeze_bill
 *
 * @author chenkw
 * @date 2021-09-22
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_funds_freeze_bill")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinVendorFundsFreezeBill extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商暂押款(释放)单")
    ...
    private List<FinVendorFundsFreezeBillItem> itemList;

    @TableField(exist = false)
    @Valid
    @ApiModelProperty(value = "暂押款附件表")
    private List<FinVendorFundsFreezeBillAttach> attachmentList;
