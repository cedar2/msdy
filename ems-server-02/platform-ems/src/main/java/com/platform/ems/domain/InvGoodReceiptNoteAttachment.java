...
/**
 * 收货单-附件对象 s_inv_good_receipt_note_attachment
 *
 * @author linhongwei
 * @date 2021-06-01
 */
...
@ApiModel
@TableName(value = "s_inv_good_receipt_note_attachment")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvGoodReceiptNoteAttachment extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-收货单附件信息")
    private Long noteAttachmentSid;

        @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long [] goodReceiptNoteAttachmentSidList;
        /** 系统SID-收货单 */
