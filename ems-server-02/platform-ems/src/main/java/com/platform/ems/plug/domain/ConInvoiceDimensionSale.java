...
/**
 * 发票维度_销售对象 s_con_invoice_dimension_sale
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_invoice_dimension_sale")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConInvoiceDimensionSale extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-销售发票维度sid")
    private Long sid;
    ...
    private Long [] sidList;
        /** 销售发票维度编码 */
        @Excel(name = "销售发票维度编码")
        @ApiModelProperty(value = "销售发票维度编码")
    private String code;

        /** 销售发票维度名称 */
        @Excel(name = "销售发票维度名称")
        @ApiModelProperty(value = "销售发票维度名称")
    private String name;
