...
/**
 * 特殊工艺检测单-检测项目对象 s_qua_specraft_check_item
 *
 * @author linhongwei
 * @date 2022-04-12
 */
...
@ApiModel
@TableName(value = "s_qua_specraft_check_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class QuaSpecraftCheckItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-特殊工艺检测单-检测项目")
    private Long specraftCheckItemSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] specraftCheckItemSidList;
    /**
     * 系统SID-特殊工艺检测单
     */
