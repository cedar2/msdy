...
/**
 * 生产日计划-明细对象 s_man_week_manufacture_plan_item
 *
 * @author hjj
 * @date 2021-07-16
 */
...
public class ManDayManufacturePlanItemResponse implements Serializable{
     ...
     * 本月计划完成量
     */
    @ApiModelProperty(value = "本日计划完成量")
    private BigDecimal planQuantity;

    /**
     * 本月计划处理次品量
     */
    @ApiModelProperty(value = "本日计划处理次品量")
