...
/**
 * 核销应收暂估日志对象 s_fin_clear_log_receipt_estimation
 *
 * @author platform
 * @date 2024-03-28
 */
...
@TableName(value = "s_fin_clear_log_receipt_estimation")
public class FinClearLogReceiptEstimation extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "应收暂估流水号")
    ...
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-核销应收暂估日志表")
    private Long clearLogReceiptEstimationSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] clearLogReceiptEstimationSidList;
