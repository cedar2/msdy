...
/**
 * 财务状况-客户-应收对象 s_rep_finance_status_yings
 *
 * @author chenkw
 * @date 2022-02-25
 */
...
@ApiModel
@TableName(value = "s_rep_finance_status_yings")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RepFinanceStatusYings extends EmsBaseEntity {
    ...
    private BigDecimal moneyAmountYings;
