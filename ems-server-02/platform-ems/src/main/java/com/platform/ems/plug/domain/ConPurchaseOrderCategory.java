...
/**
 * 采购订单类别对象 s_con_purchase_order_category
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_purchase_order_category")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConPurchaseOrderCategory extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-采购订单类别sid")
    private Long sid;
     ...
     */
    @Excel(name = "采购订单类别编码")
    @ApiModelProperty(value = "采购订单类别编码")
    private String code;
     ...
     */
    @Excel(name = "采购订单类别名称")
    @ApiModelProperty(value = "采购订单类别名称")
    private String name;
