...
/**
 * 客户互抵单明细查询请求实体 FinCustomerAccountBalanceBillItemListRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinCustomerAccountBalanceBillItemListRequest extends EmsBaseEntity implements Serializable {
