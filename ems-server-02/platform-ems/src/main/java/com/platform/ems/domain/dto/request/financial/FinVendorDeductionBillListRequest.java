...
/**
 * 供应商扣款单列表请求实体 FinVendorDeductionBillListRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinVendorDeductionBillListRequest extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "供应商扣款单号（输入框）")
