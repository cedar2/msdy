...
/**
 * 单据类型(盘点单)对象 s_con_doc_type_inventory_sheet
 *
 * @author chenkw
 * @date 2021-08-11
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_inventory_sheet")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeInventorySheet extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-单据类型(盘点单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(盘点单)类型编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(盘点单)类型名称")
    private String name;
