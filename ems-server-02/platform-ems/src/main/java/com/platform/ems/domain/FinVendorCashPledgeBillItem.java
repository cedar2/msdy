...
/**
 * 供应商押金-明细对象 s_fin_vendor_cash_pledge_bill_item
 *
 * @author chenkw
 * @date 2021-09-22
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_cash_pledge_bill_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinVendorCashPledgeBillItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商押金(退回)单明细")
     ...
     * 系统SID-供应商押金(退回)单单
     */
    @Excel(name = "系统SID-供应商押金(退回)单单")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-供应商押金(退回)单单")
