...
/**
 * 客户互抵单列表返回实体 FinCustomerAccountBalanceBillListResponse
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
public class FinCustomerAccountBalanceBillListResponse extends EmsBaseEntity implements Serializable {
