...
/**
 * 财务流水账-明细-应付对象 s_fin_book_account_payable_item
 *
 * @author linhongwei
 * @date 2021-06-03
 */
...
@ApiModel
@TableName(value = "s_fin_book_account_payable_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinBookAccountPayableItem extends EmsBaseEntity implements Serializable {
