...
@ApiModel
@TableName(value = "s_con_discount_type")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDiscountType extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-折扣类型sid")
    private Long sid;
     ...
     * 折扣类型编码
     */
    @Length(max = 8, message = "折扣类型编码不能超过8个字符")
    @NotBlank(message = "折扣类型编码不能为空")
    @Excel(name = "折扣类型编码")
     ...
     * 折扣类型名称
     */
    @NotBlank(message = "折扣类型名称不能为空")
    @Length(max = 300, message = "折扣类型名称不能超过300个字符")
    @Excel(name = "折扣类型名称")
