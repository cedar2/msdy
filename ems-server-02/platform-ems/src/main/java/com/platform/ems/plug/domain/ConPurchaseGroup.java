...
@ApiModel
@TableName(value = "s_con_purchase_group")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConPurchaseGroup extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-采购组sid")
    private Long sid;
    ...
    @Length(max = 8, message = "采购组编码不能超过8个字符")
    @Excel(name = "采购组编码")
     ...
     * 采购组名称
     */
    @NotBlank(message = "采购组名称不能为空")
    @Length(max = 300, message = "采购组名称不能超过300个字符")
    @Excel(name = "采购组名称")
