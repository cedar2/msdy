...
/**
 * 商品道序-附件对象 s_pay_product_process_step_attach
 *
 * @author c
 * @date 2021-09-08
 */
...
@ApiModel
@TableName(value = "s_pay_product_process_step_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PayProductProcessStepAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-商品道序附件表")
