...
@ApiModel
@TableName(value = "s_sys_authority_field")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SysAuthorityField extends EmsBaseEntity implements SysAuthorityEntity {
    ...
    Long authorityFieldSid;

    @ApiModelProperty(value = "权限字段sid数组")
    ...
    @ApiModelProperty(value = "权限字段来源")
    @NotEmpty(message = "权限字段来源不能为空")
    String createSource;
    ...
    @ApiModelProperty(value = "权限字段类别-多选")
    @TableField(exist = false)
    String[] categoryList;
