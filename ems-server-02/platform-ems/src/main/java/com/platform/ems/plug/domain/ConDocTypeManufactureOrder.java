...
/**
 * 单据类型_生产订单对象 s_con_doc_type_manufacture_order
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_manufacture_order")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeManufactureOrder extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-单据类型(生产订单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(生产订单)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(生产订单)名称")
    private String name;
