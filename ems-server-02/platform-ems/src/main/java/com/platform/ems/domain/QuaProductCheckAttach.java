...
/**
 * 成衣检测单-附件对象 s_qua_product_check_attach
 *
 * @author linhongwei
 * @date 2022-04-13
 */
...
@ApiModel
@TableName(value = "s_qua_product_check_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class QuaProductCheckAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-成衣检测单附件表")
    ...
    @Excel(name = "成衣检测单sid")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "成衣检测单sid")
