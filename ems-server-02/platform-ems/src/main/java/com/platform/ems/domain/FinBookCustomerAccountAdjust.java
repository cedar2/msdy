...
/**
 * 财务流水账-客户调账对象 s_fin_book_customer_account_adjust
 *
 * @author qhq
 * @date 2021-06-08
 */
...
@ApiModel
@TableName(value = "s_fin_book_customer_account_adjust")
public class FinBookCustomerAccountAdjust extends EmsBaseEntity implements Serializable {
     ...
     * 流水号（客户调账）
     */
    @Excel(name = "客户调账财务流水号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水号（客户调账）")
    ...
    @TableField(exist = false)
    private List<FinBookCustomerAccountAdjustItem> itemList;

    @TableField(exist = false)
    private List<FinBookCustomerAccountAdjustAttachment> atmList;
