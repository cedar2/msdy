...
public class InvInventorySpecialStoreStatisticsForm {
    ...
    @ApiModelProperty(value = "特殊库存 (多选)")
    ...
    @ApiModelProperty(value = "系统SID-供应商 (多选)")
    ...
    @ApiModelProperty(value = "系统SID-客户 (多选)")
    ...
    @Excel(name = "总库存量", cellType = Excel.ColumnType.NUMERIC)
