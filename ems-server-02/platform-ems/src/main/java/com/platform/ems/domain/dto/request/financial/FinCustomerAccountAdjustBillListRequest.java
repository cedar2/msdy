...
/**
 * 客户调账单列表请求实体 FinCustomerAccountAdjustBillListRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinCustomerAccountAdjustBillListRequest extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "客户调账单号（输入框）")
