...
public class BarcodeUtils {
     ...
     */
    public static void generateBarCode128(String message, Double height, Double width, boolean withQuietZone, boolean hideText, ByteArrayOutputStream outputStream) {
