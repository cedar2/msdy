...
/**
 * 供应商调账单-明细对象 s_fin_vendor_account_adjust_bill_item
 *
 * @author qhq
 * @date 2021-05-26
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_account_adjust_bill_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinVendorAccountAdjustBillItem extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "系统SID-供应商调账单明细")
    ...
    /**
     * 配置档案表 s_con_adjust_type_vendor
     */
    @Excel(name = "调账类型")
    @TableField(exist = false)
