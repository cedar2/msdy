...
/**
 * 加工询价单-供应商对象 s_pur_outsource_inquiry_vendor
 *
 * @author chenkw
 * @date 2022-03-21
 */
...
@ApiModel
@TableName(value = "s_pur_outsource_inquiry_vendor")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PurOutsourceInquiryVendor extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-加工询价单供应商信息")
    private Long outsourceInquiryVendorSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] outsourceInquiryVendorSidList;

    /**
     * 系统SID-加工询价单
     */
    @Excel(name = "系统SID-加工询价单")
    @JsonSerialize(using = ToStringSerializer.class)
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "系统SID-加工询价单数组")
