...
/**
 * 打样准许单-附件对象 s_dev_make_sample_form_attach
 *
 * @author linhongwei
 * @date 2022-03-24
 */
...
@ApiModel
@TableName(value = "s_dev_make_sample_form_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DevMakeSampleFormAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-打样准许单附件表")
    ...
    @Excel(name = "打样准许单sid")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "打样准许单sid")
