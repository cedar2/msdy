...
@ApiModel
@TableName(value = "s_con_project")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConProject extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-项目sid")
    private Long sid;
    ...
    @Length(max = 8, message = "项目编码不能超过8个字符")
    @Excel(name = "项目编码")
    ...
    @Length(max = 300, message = "项目名称不能超过300个字符")
    @Excel(name = "项目名称")
