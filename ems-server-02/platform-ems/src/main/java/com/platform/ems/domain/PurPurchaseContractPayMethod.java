...
/**
 * 采购合同信息-支付方式对象 s_pur_purchase_contract_pay_method
 *
 * @author linhongwei
 * @date 2022-05-17
 */
...
@ApiModel
@TableName(value = "s_pur_purchase_contract_pay_method")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PurPurchaseContractPayMethod extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "支付方式（配置档案的编码）")
