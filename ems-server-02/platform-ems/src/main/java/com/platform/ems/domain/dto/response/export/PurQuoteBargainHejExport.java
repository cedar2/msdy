 ...
 */
@Data
public class PurQuoteBargainHejExport {

    @Excel(name = "采购核价单号")
    @ApiModelProperty(value = "采购核价单号")
    ...
    @Excel(name = "递增核定价(含税)", cellType = Excel.ColumnType.NUMERIC)
    ...
    @Excel(name = "递减核定价(含税)", cellType = Excel.ColumnType.NUMERIC)
