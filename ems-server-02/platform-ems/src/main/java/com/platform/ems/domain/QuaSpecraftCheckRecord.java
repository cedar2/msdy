...
/**
 * 特殊工艺检测问题台账对象 s_qua_specraft_check_record
 *
 * @author admin
 * @date 2024-03-06
 */
...
@ApiModel
@TableName(value = "s_qua_specraft_check_record")
public class QuaSpecraftCheckRecord extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-特殊工艺检测记录")
    private Long specraftCheckRecordSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] specraftCheckRecordSidList;
    ...
    @Excel(name = "记录编号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "特殊工艺检测记录编号")
    private Long specraftCheckRecordCode;
    ...
    /**
     * 特殊工艺类型（数据字典的键值或配置档案的编码）
     */
    @Excel(name = "特殊工艺类型", dictType = "s_specraft_type")
    @ApiModelProperty(value = "特殊工艺类型（数据字典的键值或配置档案的编码）")
    private String specraftType;

    @TableField(exist = false)
    @ApiModelProperty(value = "特殊工艺类型（数据字典的键值或配置档案的编码）")
    private String[] specraftTypeList;
    ...
    @TableField(exist = false)
    @ApiModelProperty(value ="检测日期开始时间")
    private String checkDateBegin;

    @TableField(exist = false)
    @ApiModelProperty(value ="检测日期结束时间")
    ...
    private List<QuaSpecraftCheckRecordAttach> attachmentList;
}
