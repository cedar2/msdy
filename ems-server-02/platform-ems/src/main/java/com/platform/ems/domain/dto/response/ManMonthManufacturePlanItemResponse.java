...
/**
 * 生产月计划-明细对象 s_man_week_manufacture_plan_item
 *
 * @author hjj
 * @date 2021-07-16
 */
...
public class ManMonthManufacturePlanItemResponse implements Serializable {
    /**
     * 系统SID-生产月计划单明细
     */
     ...
     * 本月计划处理次品量
     */
    @ApiModelProperty(value = "本月计划处理次品量")
