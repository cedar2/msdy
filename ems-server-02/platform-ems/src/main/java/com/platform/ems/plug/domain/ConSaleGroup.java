...
@ApiModel
@TableName(value = "s_con_sale_group")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConSaleGroup extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-销售组sid")
    private Long sid;
     ...
     * 销售组编码
     */
    @NotBlank(message = "销售组编码不能为空")
    @Length(max = 8, message = "销售组编码不能超过8个字符")
    @Excel(name = "销售组编码")
    ...
    @Length(max = 8, message = "销售组名称不能超过8个字符")
    @Excel(name = "销售组名称")
