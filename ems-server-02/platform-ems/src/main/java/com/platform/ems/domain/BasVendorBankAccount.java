...
/**
 * 供应商银行账户信息对象 s_bas_vendor_bank_account
 *
 * @author qhq
 * @date 2021-03-12
 */
...
@ApiModel
@TableName(value = "s_bas_vendor_bank_account")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasVendorBankAccount extends EmsBaseEntity {
    ...
    /** 系统ID-供应商银行账户信息 */
    @Excel(name = "系统ID-供应商银行账户信息")
    @ApiModelProperty(value = "系统ID-供应商银行账户信息")
    @JsonSerialize(using = ToStringSerializer.class)
    @TableId
    private Long vendorBankAccountSid;
    ...
    /** 银行账号 */
    @NotBlank(message = "财务信息银行账号不能为空")
    @Excel(name = "银行账号")
    @ApiModelProperty(value = "银行账号")
    private String bankAccount;

    /** 收款方名称 */
    @NotBlank(message = "财务信息收款方名称不能为空")
    @Excel(name = "收款方名称")
