...
/**
 * 供应商调账单对象 s_fin_vendor_account_adjust_bill
 *
 * @author qhq
 * @date 2021-05-26
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_account_adjust_bill")
public class FinVendorAccountAdjustBill extends EmsBaseEntity implements Serializable {
    ...
    private List<FinVendorAccountAdjustBillItem> itemList;
