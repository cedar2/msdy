...
/**
 * 仓库-联系方式信息对象 s_bas_storehouse_addr
 *
 * @author chenkw
 * @date 2022-01-05
 */
...
@TableName(value = "s_bas_storehouse_addr")
@ApiModel
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasStorehouseAddr extends EmsBaseEntity {
     ...
     * 系统ID-仓库联系信息
     */
    @Excel(name = "系统ID-仓库联系信息")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统ID-仓库联系信息")
    @TableId
    private Long storehouseContactSid;
     ...
     * 联系人归属业务类型编码
     */
    @Excel(name = "联系人归属业务类型编码", dictType = "s_business_type_contact")
