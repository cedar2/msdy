...
/**
 * 财务流水账-供应商账互抵对象 s_fin_book_vendor_account_balance
 *
 * @author qhq
 * @date 2021-06-18
 */
...
@ApiModel
@TableName(value = "s_fin_book_vendor_account_balance")
public class FinBookVendorAccountBalance extends EmsBaseEntity {
    ...
    @Excel(name = "供应商账互抵财务流水号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水号（供应商账互抵）")
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "系统SID-采购员")
