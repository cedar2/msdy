...
@ApiModel
@TableName(value = "s_inv_good_issue_note")
//@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvGoodIssueNote extends EmsBaseEntity {
    ...
    private Long[] goodIssueNoteSidList;
    ...
    @Valid
    @TableField(exist = false)
    private List<InvGoodIssueNoteItem> listInvGoodIssueNoteItem;

    @TableField(exist = false)
    private List<InvGoodIssueNoteAttachment> attachmentList;
    @TableField(exist = false)
    @Excel(name = "公司编码")
