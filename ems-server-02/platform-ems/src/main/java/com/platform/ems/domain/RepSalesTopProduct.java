...
/**
 * 销售TOP10款对象 s_rep_sales_top_product
 *
 * @author linhongwei
 * @date 2022-02-25
 */
...
@ApiModel
@TableName(value = "s_rep_sales_top_product")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RepSalesTopProduct {
     ...
     * 类型：按销量、按销售金额
     */
    @Excel(name = "类型：按销量、按销售金额")
    @ApiModelProperty(value = "类型：按销量、按销售金额")
