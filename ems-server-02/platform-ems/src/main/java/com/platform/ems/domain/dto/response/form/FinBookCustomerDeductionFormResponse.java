...
/**
 * 客户扣款流水报表 FinBookCustomerDeductionFormResponse
 *
 * @author chenkaiwen
 * @date 2021-07-13
 */
...
public class FinBookCustomerDeductionFormResponse extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "流水账（客户扣款）")
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水号（客户扣款）")
