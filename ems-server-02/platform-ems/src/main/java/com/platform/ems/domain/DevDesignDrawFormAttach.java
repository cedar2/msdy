...
/**
 * 图稿批复单-附件对象 s_dev_design_draw_form_attach
 *
 * @author qhq
 * @date 2021-11-05
 */
...
@ApiModel
@TableName(value = "s_dev_design_draw_form_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DevDesignDrawFormAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-图稿批复单附件表")
    ...
    @Excel(name = "图稿批复单sid")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "图稿批复单sid")
