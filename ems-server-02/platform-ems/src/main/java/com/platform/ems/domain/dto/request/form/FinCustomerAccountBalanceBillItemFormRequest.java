...
/**
 *  客户互抵明细报表 FinCustomerAccountBalanceBillItemFormRequest
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
@ApiModel
public class FinCustomerAccountBalanceBillItemFormRequest extends EmsBaseEntity implements Serializable {
