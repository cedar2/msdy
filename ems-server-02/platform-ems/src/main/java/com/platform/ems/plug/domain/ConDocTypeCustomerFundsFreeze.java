...
/**
 * 单据类型_客户暂押款对象 s_con_doc_type_customer_funds_freeze
 *
 * @author linhongwei
 * @date 2021-09-25
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_customer_funds_freeze")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeCustomerFundsFreeze extends EmsBaseEntity {
    ...
    /**
     * 系统SID-单据类型(客户暂押款)sid
     */
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-单据类型(客户暂押款)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(客户暂押款)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(客户暂押款)名称")
    private String name;
