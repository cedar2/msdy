...
@ApiModel
@TableName(value = "s_con_shipment_mode")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConShipmentMode extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-配送方式sid")
    private Long sid;
     ...
     * 配送方式编码
     */
    @Length(max = 8, message = "配送方式编码不能超过8个字符")
     ...
     * 配送方式名称
     */
    @Length(max = 300, message = "配送方式名称不能超过300个字符")
