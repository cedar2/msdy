...
/**
 * 仓库档案-附件对象 s_bas_storehouse_attach
 *
 * @author chenkw
 * @date 2021-09-15
 */
...
@ApiModel
@TableName(value = "s_bas_storehouse_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasStorehouseAttach extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-仓库档案附件表")
