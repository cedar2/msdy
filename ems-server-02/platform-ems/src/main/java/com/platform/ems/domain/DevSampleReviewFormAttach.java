...
/**
 * 样品评审单-附件对象 s_dev_sample_review_form_attach
 *
 * @author linhongwei
 * @date 2022-03-23
 */
...
@ApiModel
@TableName(value = "s_dev_sample_review_form_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DevSampleReviewFormAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-样品评审单附件表")
    ...
    @Excel(name = "样品评审单sid")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "样品评审单sid")
