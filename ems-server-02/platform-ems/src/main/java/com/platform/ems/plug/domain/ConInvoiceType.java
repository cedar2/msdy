...
@ApiModel
@TableName(value = "s_con_invoice_type")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConInvoiceType extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-发票类型sid")
    private Long sid;
     ...
     * 发票类型编码
     */
    @NotBlank(message = "发票类型编码不能为空")
    @Length(max = 8, message = "发票类型编码不能超过8个字符")
    @Excel(name = "发票类型编码")
    ...
    @Length(max = 300, message = "发票类型名称不能超过300个字符")
    @Excel(name = "发票类型名称")
