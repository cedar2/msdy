...
/**
 * 公司档案-附件对象 s_bas_company_attach
 *
 * @author chenkw
 * @date 2021-09-15
 */
...
@ApiModel
@TableName(value = "s_bas_company_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasCompanyAttach extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-公司档案附件表")
