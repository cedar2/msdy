...
/**
 * 采购状况-面辅料/商品对象 s_rep_purchase_status_material
 *
 * @author linhongwei
 * @date 2022-02-25
 */
...
@ApiModel
@TableName(value = "s_rep_purchase_status_material")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RepPurchaseStatusMaterial {
     ...
     */
    @Excel(name = "采购模式code")
    @ApiModelProperty(value = "采购模式code")
    private String purchaseModeCode;
