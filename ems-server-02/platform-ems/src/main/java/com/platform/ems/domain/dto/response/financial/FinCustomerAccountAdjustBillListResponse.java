...
/**
 * 客户调账单列表查询返回实体 FinCustomerAccountAdjustBillListResponse
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
public class FinCustomerAccountAdjustBillListResponse extends EmsBaseEntity implements Serializable {
