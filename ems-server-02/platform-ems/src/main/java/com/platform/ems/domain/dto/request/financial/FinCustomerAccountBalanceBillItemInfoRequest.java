...
/**
 * 客户互抵单明细详情请求实体 FinCustomerAccountBalanceBillItemInfoRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinCustomerAccountBalanceBillItemInfoRequest extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "客户sid （单选）")
