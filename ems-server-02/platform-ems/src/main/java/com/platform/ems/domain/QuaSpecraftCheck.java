...
/**
 * 特殊工艺检测单-主对象 s_qua_specraft_check
 *
 * @author linhongwei
 * @date 2022-04-12
 */
...
@ApiModel
@TableName(value = "s_qua_specraft_check")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class QuaSpecraftCheck extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-特殊工艺检测单")
    private Long specraftCheckSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] specraftCheckSidList;
    ...
    @Excel(name = "特殊工艺检测单号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "特殊工艺检测单号")
    private Long specraftCheckCode;
    ...
    private Long preSpecraftCheckSid;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "特殊工艺检测单-款明细")
    private List<QuaSpecraftCheckProducts> productList;

    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "特殊工艺检测单-检测项目")
    private List<QuaSpecraftCheckItem> itemList;

    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "特殊工艺检测单-附件")
    private List<QuaSpecraftCheckAttach> attachList;
