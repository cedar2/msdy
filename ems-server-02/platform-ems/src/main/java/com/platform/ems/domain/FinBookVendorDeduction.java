...
/**
 * 财务流水账-供应商扣款对象 s_fin_book_vendor_deduction
 *
 * @author qhq
 * @date 2021-06-02
 */
...
@ApiModel
@TableName(value = "s_fin_book_vendor_deduction")
public class FinBookVendorDeduction extends EmsBaseEntity implements Serializable {
    ...
    @TableField(exist = false)
    private List<FinBookVendorDeductionItem> itemList;

    @ApiModelProperty(value = "附件表")
    @TableField(exist = false)
    private List<FinBookVendorDeductionAttachment> atmList;
