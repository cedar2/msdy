...
/**
 * 核销客户扣款日志对象 s_fin_clear_log_customer_deduction
 *
 * @author platform
 * @date 2024-03-28
 */
...
@TableName(value = "s_fin_clear_log_customer_deduction")
public class FinClearLogCustomerDeduction extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-核销客户扣款日志表")
    private Long clearLogCustomerDeductionSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] clearLogCustomerDeductionSidList;
