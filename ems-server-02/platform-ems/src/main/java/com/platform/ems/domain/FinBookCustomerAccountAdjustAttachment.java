...
/**
 * 财务流水账-附件-客户调账对象 s_fin_book_customer_account_adjust_attachment
 *
 * @author linhongwei
 * @date 2021-06-08
 */
...
@ApiModel
@TableName(value = "s_fin_book_customer_account_adjust_attachment")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinBookCustomerAccountAdjustAttachment extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-流水账附件（客户调账）")
