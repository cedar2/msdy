...
/**
 * 单据类型_需求单对象 s_con_doc_type_require_document
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_require_document")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeRequireDocument extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-单据类型(需求单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(需求单)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(需求单)名称")
    private String name;
