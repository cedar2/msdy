...
/**
 * 客户返修台账对象 s_inv_record_customer_repair
 *
 * @author linhongwei
 * @date 2021-10-27
 */
...
@ApiModel
@TableName(value = "s_inv_record_customer_repair")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvRecordCustomerRepair extends EmsBaseEntity{
    ...
    private Long[] customerRepairSidList;
    /**
     * 客户返修台账流水号
     */
    ...
    @TableField(exist = false)
    List<InvRecordCustomerRepairItem> listItem;

    @TableField(exist = false)
    List<InvRecordCustomerRepairAttach> listAttach;
