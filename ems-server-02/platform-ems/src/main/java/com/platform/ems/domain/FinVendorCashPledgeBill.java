...
/**
 * 供应商押金对象 s_fin_vendor_cash_pledge_bill
 *
 * @author chenkw
 * @date 2021-09-22
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_cash_pledge_bill")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinVendorCashPledgeBill extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商押金(退回)单信息")
    ...
    @TableField(exist = false)
    @Valid
    @ApiModelProperty(value = "押金明细表")
    private List<FinVendorCashPledgeBillItem> itemList;

    @TableField(exist = false)
    @Valid
    @ApiModelProperty(value = "押金附件表")
    private List<FinVendorCashPledgeBillAttach> attachmentList;
