...
/**
 * 客户特殊库存（寄售/客供料）对象 s_inv_cus_special_inventory
 *
 * @author linhongwei
 * @date 2021-06-01
 */
...
@ApiModel
@TableName(value = "s_inv_cus_special_inventory")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvCusSpecialInventory extends EmsBaseEntity{
    ...
    private Long[] customerSpecialStockSidList;
    /**
     * 系统SID-物料&商品&服务
     */
    ...
    @Excel(name = "最开始的库存量")
    @TableField(exist = false)
    private BigDecimal unlimitedQuantityOrigin;
