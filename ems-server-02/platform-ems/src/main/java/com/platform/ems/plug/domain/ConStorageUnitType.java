...
/**
 * 托盘类型对象 s_con_storage_unit_type
 *
 * @author linhongwei
 * @date 2021-05-19
 */
...
@ApiModel
@TableName(value = "s_con_storage_unit_type")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConStorageUnitType extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-托盘类型sid")
    private Long sid;
     ...
     * 托盘类型编码
     */
    @Length(max = 8, message = "托盘类型编码不能超过8个字符")
    @NotBlank(message = "托盘类型编码不能为空")
    @Excel(name = "托盘类型编码")
     ...
     * 托盘类型名称
     */
    @Length(max = 300, message = "托盘类型名称不能超过300个字符")
    @NotBlank(message = "托盘类型名称不能为空")
    @Excel(name = "托盘类型名称")
