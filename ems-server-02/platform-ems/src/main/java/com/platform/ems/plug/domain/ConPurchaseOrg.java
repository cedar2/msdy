...
@ApiModel
@TableName(value = "s_con_purchase_org")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConPurchaseOrg extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-采购组织sid")
    private Long sid;
    ...
    @Length(max = 8, message = "采购组织编码不能超过8个字符")
    @Excel(name = "采购组织编码")
    ...
    @Length(max = 300, message = "采购组织名称不能超过300个字符")
    @Excel(name = "采购组织名称")
