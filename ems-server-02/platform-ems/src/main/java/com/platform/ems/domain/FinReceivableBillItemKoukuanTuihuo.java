...
/**
 * 收款单-核销退货扣款明细表对象 s_fin_receivable_bill_item_koukuan_tuihuo
 *
 * @author platform
 * @date 2024-03-12
 */
...
@TableName(value = "s_fin_receivable_bill_item_koukuan_tuihuo")
public class FinReceivableBillItemKoukuanTuihuo extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-收款单核销退货扣款明细")
    private Long receivableBillItemKoukuanTuihuoSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] receivableBillItemKoukuanTuihuoSidList;
