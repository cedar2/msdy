...
@ApiModel
@TableName(value = "s_con_material_type")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConMaterialType extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-物料类型sid")
    private Long sid;
    ...
    @Length(max = 8, message = "物料类型编码不能超过8个字符")
    ...
    @Length(max = 300, message = "物料类型名称不能超过300个字符")
