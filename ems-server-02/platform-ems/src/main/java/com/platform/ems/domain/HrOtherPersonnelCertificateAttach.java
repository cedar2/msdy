...
/**
 *  其它人事证明-附件对象 s_hr_other_personnel_certificate_attach
 *
 * @author xfzz
 * @date 2024/5/7
 */
...
@ApiModel
@TableName(value = "s_hr_other_personnel_certificate_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HrOtherPersonnelCertificateAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-其它人事证明附件信息")
    private Long otherPersonnelCertificateAttachSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] otherPersonnelCertificateAttachSidList;
