...
/**
 * 供应商调账单明细报表 FinVendorAccountAdjustBillItemFormResponse
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
public class FinVendorAccountAdjustBillItemFormResponse extends EmsBaseEntity implements Serializable {
