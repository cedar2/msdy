...
/**
 * 客户互抵单明细详情返回实体 FinCustomerAccountBalanceBillItemInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
public class FinCustomerAccountBalanceBillItemInfoResponse extends EmsBaseEntity implements Serializable {
