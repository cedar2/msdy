...
/**
 * 供应商扣款单对象 s_fin_vendor_deduction_bill
 *
 * @author qhq
 * @date 2021-05-31
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_deduction_bill")
public class FinVendorDeductionBill extends EmsBaseEntity implements Serializable {
     ...
     */
    @Excel(name = "采购组织（数据字典的键值或配置档案的编码）")
     ...
     */
    @TableField(exist = false)
    private List<FinVendorDeductionBillItem> itemList;
