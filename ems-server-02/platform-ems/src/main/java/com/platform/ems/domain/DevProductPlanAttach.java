...
/**
 * 品类规划信息-附件对象 s_dev_product_plan_attach
 *
 * @author qhq
 * @date 2021-11-08
 */
...
@ApiModel
@TableName(value = "s_dev_product_plan_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DevProductPlanAttach extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-品类规划信息附件表")
    ...
    private Long [] attachmentSidList;
        /** 品类规划信息sid */
        @Excel(name = "品类规划信息sid")
        @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "品类规划信息sid")
