...
/**
 * 外采样报销单-附件对象 s_sam_osb_sample_reimburse_attach
 *
 * @author qhq
 * @date 2021-12-28
 */
...
@ApiModel
@TableName(value = "s_sam_osb_sample_reimburse_attach")
public class SamOsbSampleReimburseAttach extends EmsBaseEntity {
    /** 租户ID */
    @Excel(name = "租户ID")
    ...
    @ApiModelProperty(value = "系统SID-外采样报销单附件表")
