...
/**
 * 供应商发票台账表对象 s_fin_vendor_invoice_record
 *
 * @author platform
 * @date 2024-03-12
 */
...
@TableName(value = "s_fin_vendor_invoice_record")
public class FinVendorInvoiceRecord extends EmsBaseEntity {
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "付款状态")
    private String[] fukuanStatusList;

    /**
     * 待付款金额=票面金额(含税)-所有引用此发票台账的付款单对应发票台账明细的金额(含税)和
     */
    @TableField(exist = false)
    @Excel(name = "待付款金额", cellType = Excel.ColumnType.NUMERIC)
    @ApiModelProperty(value = "待付款金额")
    private BigDecimal currencyAmountTaxDai;

    /**
     * 付款中金额=付款中金额=票面金额(含税)-待付款金额-已付款金额
     */
    @TableField(exist = false)
    @Excel(name = "付款中金额", cellType = Excel.ColumnType.NUMERIC)
    @ApiModelProperty(value = "付款中金额")
    private BigDecimal currencyAmountTaxZhong;

    /**
     * 已付款金额=票面金额(含税)-待付款金额-已付款金额
     */
    @TableField(exist = false)
    @Excel(name = "已付款金额", cellType = Excel.ColumnType.NUMERIC)
    ...
    List<FinVendorInvoiceRecordAttachment> attachmentList;
