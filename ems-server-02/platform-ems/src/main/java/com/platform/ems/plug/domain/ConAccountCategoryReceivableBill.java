...
/**
 * 款项类别_收款单对象 s_con_account_category_receivable_bill
 *
 * @author linhongwei
 * @date 2021-05-19
 */
...
@ApiModel
@TableName(value = "s_con_account_category_receivable_bill")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConAccountCategoryReceivableBill extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-收款单款项类别sid")
    private Long sid;
     ...
     * 收款单款项类别编码
     */
    @Excel(name = "收款单款项类别编码")
    @ApiModelProperty(value = "收款单款项类别编码")
    private String code;

    /**
     * 收款单款项类别名称
     */
    @Excel(name = "收款单款项类别名称")
    @ApiModelProperty(value = "收款单款项类别名称")
    private String name;
