...
/**
 * 单据类型_库存调整单对象 s_con_doc_type_inventory_adjust
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_inventory_adjust")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeInventoryAdjust extends EmsBaseEntity {
    ...
    /**
     * 系统SID-单据类型(库存调整单)sid
     */
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-单据类型(库存调整单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(库存调整单)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(库存调整单)名称")
    private String name;
