...
/**
 * 供应商暂押款明细报表 FinVendorFundsFreezeBillItemFormResponse
 *
 * @author chenkaiwen
 * @date 2021-11-11
 */
...
public class FinVendorFundsFreezeBillItemFormResponse extends EmsBaseEntity implements Serializable {
