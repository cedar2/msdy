...
/**
 * 新品试销计划单对象 s_frm_newproduct_trialsale_plan
 *
 * @author chenkw
 * @date 2022-12-16
 */
...
@ApiModel
@TableName(value = "s_frm_newproduct_trialsale_plan")
public class FrmNewproductTrialsalePlan extends EmsBaseEntity {
    ...
    private Long[] newproductTrialsalePlanSidList;
    ...
    @Excel(name = "新品试销计划单号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "新品试销计划单号")
    private Long newproductTrialsalePlanCode;
    ...
    @Excel(name = "试销计划日期(起)", width = 30, dateFormat = "yyyy-MM-dd")
    @ApiModelProperty(value = "试销计划日期(起)")
    private Date trialsalePlanDateStart;

    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @Excel(name = "试销计划日期(至)", width = 30, dateFormat = "yyyy-MM-dd")
    @ApiModelProperty(value = "试销计划日期(至)")
    private Date trialsalePlanDateEnd;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "关键词分析列表")
    private List<FrmTrialsalePlanKeyWord> keyWordList;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "类目分析列表")
    private List<FrmTrialsalePlanCategoryAnalysis> analysisList;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "目标预定列表")
    private List<FrmTrialsalePlanTarget> targetList;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "CPC模拟数据列表")
    private List<FrmTrialsalePlanCpcSimulate> cpcSimulateList;
    ...
    @Valid
    @TableField(exist = false)
    @ApiModelProperty(value = "利润模拟列表")
    private List<FrmTrialsalePlanProfitSimulate> profitSimulateList;
    ...
    private List<FrmNewproductTrialsalePlanAttach> attachmentList;
