...
/**
 *  劳动合同-附件对象 s_hr_labor_contract_attach
 *
 * @author xfzz
 * @date 2024/5/7
 */
...
@ApiModel
@TableName(value = "s_hr_labor_contract_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HrLaborContractAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-劳动合同附件信息")
    private Long laborContractAttachSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] laborContractAttachSidList;
