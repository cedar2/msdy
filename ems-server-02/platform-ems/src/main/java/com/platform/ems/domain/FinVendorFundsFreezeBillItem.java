...
/**
 * 供应商暂押款-明细对象 s_fin_vendor_funds_freeze_bill_item
 *
 * @author chenkw
 * @date 2021-09-22
 */
...
@ApiModel
@TableName(value = "s_fin_vendor_funds_freeze_bill_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinVendorFundsFreezeBillItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商暂押款(释放)单明细")
