...
/**
 *  采购发票明细表详情数据接收实体 FinPurchaseInvoiceItemInfoRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinPurchaseInvoiceItemInfoRequest extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "物料&商品&服务SKU1名称")
    ...
    @ApiModelProperty(value = "物料&商品&服务SKU2名称")
    private String sku2Name;

    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-物料&商品&服务商品条码sid")
    ...
    @ApiModelProperty(value = "采购单位（数据字典的键值）")
    ...
    List<FinPurchaseInvoiceItemChildRequest> children;

    @ApiModelProperty(value = "分组唯一键值")
    private String key;
}
