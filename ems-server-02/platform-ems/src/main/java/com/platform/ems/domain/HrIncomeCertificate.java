...
@ApiModel
@TableName(value = "s_hr_income_certificate")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HrIncomeCertificate extends EmsBaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "系统SID-收入证明")
    private Long incomeCertificateSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] incomeCertificateSidList;

    /**
     * 收入证明信息sids
     */
    @TableField(exist = false)
    @ApiModelProperty(value = "收入证明信息sids")
    private List<Long> incomeCertificateSids;

    /**
     * 收入证明记录号
     */
    @Excel(name = "收入证明记录号")
    @ApiModelProperty(value = "收入证明记录号")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long incomeCertificateCode;
    ...
    private List<HrIncomeCertificateAttach> attachmentList;
}
