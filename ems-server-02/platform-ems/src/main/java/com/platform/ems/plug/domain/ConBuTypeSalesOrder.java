...
/**
 * 业务类型_销售订单对象 s_con_bu_type_sales_order
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_bu_type_sales_order")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConBuTypeSalesOrder extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-业务类型(销售订单)sid")
    private Long sid;
    ...
    @Length(max = 8, message = "业务类型编码不能超过8个字符")
    @Excel(name = "业务类型编码")
    @ApiModelProperty(value = "业务类型(销售订单)编码")
    private String code;
    ...
    @Length(max = 300, message = "业务类型名称不能超过300个字符")
    @Excel(name = "业务类型名称")
    @ApiModelProperty(value = "业务类型(销售订单)名称")
    private String name;

    /**
     * 销售发货类型（数据字典的键值或配置档案的编码）
     */
    ...
    /**
     * 是否允许编辑价格（数据字典的键值或配置档案的编码）
     */
    @Excel(name = "是否允许编辑价格", dictType = "sys_yes_no")
    @ApiModelProperty(value = "是否允许编辑价格（数据字典的键值或配置档案的编码）")
    private String isEditPrice;

    /**
     * 是否预留库存（数据字典的键值或配置档案的编码）
     */
    @Excel(name = "是否预留库存", dictType = "sys_yes_no")
    @ApiModelProperty(value = "是否预留库存（数据字典的键值或配置档案的编码）")
    private String isReserveStock;

    @NotBlank(message = "请选择是否为供应商直发客户")
    @Excel(name = "供应商直发客户", dictType = "sys_yes_no")
    @ApiModelProperty(value = "供应商直发客户（数据字典的键值或配置档案的编码）")
    private String isVendorTransport;

    /**
     * 是否一次性销售
     */
    @Excel(name = "是否一次性销售" , dictType = "sys_yes_no")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "是否一次性销售")
    @NotBlank(message = "请选择是否一次性销售")
    private String isOnceSale;
