...
/**
 * 单据类型_销售订单对象 s_con_doc_type_sales_order
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_sales_order")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeSalesOrder extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-单据类型(销售订单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(销售订单)编码")
    private String code;
