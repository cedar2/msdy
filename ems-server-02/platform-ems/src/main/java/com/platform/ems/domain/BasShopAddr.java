...
@ApiModel
@TableName(value = "s_bas_shop_addr")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasShopAddr extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-店铺联系信息")
    private Long shopContactSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] shopContactSidList;
    /**
     * 店铺档案sid
     */
    @Excel(name = "店铺档案sid")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "店铺档案sid")
