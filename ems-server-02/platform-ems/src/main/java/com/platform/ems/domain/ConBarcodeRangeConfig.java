...
/**
 * 物料/商品/服务条码号码段配置对象 s_con_barcode_range_config
 *
 * @author linhongwei
 * @date 2021-06-03
 */
...
@ApiModel
@TableName(value = "s_con_barcode_range_config")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConBarcodeRangeConfig extends EmsBaseEntity {
    ...
    /**
     * 系统SID-物料/商品/服务条码号码段配置
     */
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-物料/商品/服务条码号码段配置")
