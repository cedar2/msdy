...
/**
 * 财务流水账-明细-应付暂估对象 s_fin_book_payment_estimation_item
 *
 * @author qhq
 * @date 2021-05-31
 */
...
@ApiModel
@TableName(value = "s_fin_book_payment_estimation_item")
public class FinBookPaymentEstimationItem extends EmsBaseEntity implements Serializable {
    ...
    /** 采购单位（数据字典的键值或配置档案的编码） */
    @Excel(name = "采购单位（数据字典的键值或配置档案的编码）")
    @ApiModelProperty(value = "采购单位（数据字典的键值或配置档案的编码）")
