...
/**
 * 实验室-附件对象 s_bas_laboratory_attach
 *
 * @author c
 * @date 2022-03-31
 */
...
@ApiModel
@TableName(value = "s_bas_laboratory_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasLaboratoryAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-实验室附件表")
