...
/**
 * 供应商推荐-联系方式信息对象 s_bas_vendor_recommend_addr
 *
 * @author chenkw
 * @date 2022-02-21
 */
...
@ApiModel
@TableName(value = "s_bas_vendor_recommend_addr")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasVendorRecommendAddr extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商推荐联系信息sid")
    private Long vendorRecommendContactSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] vendorRecommendContactSidList;
