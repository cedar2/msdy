...
/**
 * 收款单-核销扣款明细表对象 s_fin_receivable_bill_item_koukuan
 *
 * @author platform
 * @date 2024-03-12
 */
...
@TableName(value = "s_fin_receivable_bill_item_koukuan")
public class FinReceivableBillItemKoukuan extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-收款单核销扣款明细")
    private Long receivableBillItemKoukuanSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] receivableBillItemKoukuanSidList;
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水账编号（客户扣款）")
