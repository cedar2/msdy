...
/**
 * 供应商互抵单明细查询请求返回实体 FinVendorAccountBalanceBillItemListReponse
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
public class FinVendorAccountBalanceBillItemListReponse extends EmsBaseEntity implements Serializable {
