...
/**
 * 采购合同信息-附件对象 s_pur_purchase_contract_attachment
 *
 * @author linhongwei
 * @date 2021-05-19
 */
...
@ApiModel
@TableName(value = "s_pur_purchase_contract_attachment")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PurPurchaseContractAttachment extends EmsBaseEntity {
    ...
    private Long purchaseContractAttachmentSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] purchaseContractAttachmentSidList;
    /**
     * 系统自增长ID-采购合同
     */
