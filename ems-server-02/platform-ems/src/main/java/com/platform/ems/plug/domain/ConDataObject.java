...
@ApiModel
@TableName(value = "s_con_data_object")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDataObject extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-数据对象sid")
    private Long sid;
     ...
     * 数据对象编码
     */
    @NotBlank(message = "数据对象编码不能为空")
    @Length(max = 8, message = "数据对象编码不能超过8个字符")
    @Excel(name = "数据对象编码")
    ...
    @Length(max = 300, message = "数据对象名称不能超过300个字符")
    @Excel(name = "数据对象名称")
