...
/**
 * 收款单-核销货款明细表 s_fin_receivable_bill_item_huokuan
 */
@Data
@Accessors(chain = true)
@TableName(value = "s_fin_receivable_bill_item_huokuan")
public class FinReceivableBillItemHuokuan extends EmsBaseEntity {
    ...
    private Long receivableBillItemHuokuanSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] receivableBillItemHuokuanSidList;
