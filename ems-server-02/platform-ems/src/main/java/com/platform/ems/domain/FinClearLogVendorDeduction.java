...
/**
 * 核销供应商扣款日志对象 s_fin_clear_log_vendor_deduction
 *
 * @author platform
 * @date 2024-03-28
 */
...
@TableName(value = "s_fin_clear_log_vendor_deduction")
public class FinClearLogVendorDeduction extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-核销供应商扣款日志表")
    private Long clearLogVendorDeductionSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] clearLogVendorDeductionSidList;
