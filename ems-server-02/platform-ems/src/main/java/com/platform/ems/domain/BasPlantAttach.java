...
@ApiModel
@TableName(value = "s_bas_plant_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasPlantAttach extends EmsBaseEntity{
    ...
    @ApiModelProperty(value = "系统SID-工厂档案附件表")
