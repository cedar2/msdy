...
/**
 * 财务流水账-明细-客户账互抵对象 s_fin_book_customer_account_balance_item
 *
 * @author linhongwei
 * @date 2021-06-11
 */
...
@ApiModel
@TableName(value = "s_fin_book_customer_account_balance_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinBookCustomerAccountBalanceItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-流水账明细（客户账互抵）")
