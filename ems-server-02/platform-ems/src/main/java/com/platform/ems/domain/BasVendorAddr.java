...
/**
 * 供应商-联系方式信息对象 s_bas_vendor_addr
 *
 * @author linhongwei
 * @date 2021-01-31
 */
...
@ApiModel
@TableName(value = "s_bas_vendor_addr")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasVendorAddr extends EmsBaseEntity {
    ...
    /** 系统ID-供应商联系信息 */
    @Excel(name = "系统ID-供应商联系信息")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统ID-供应商联系信息")
    @TableId
    private Long vendorContactSid;
