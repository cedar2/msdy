...
@ApiModel
@TableName(value = "s_hr_dimission_certificate")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HrDimissionCertificate extends EmsBaseEntity implements Serializable {
    ...
    @TableField(exist = false)
    private Long[] dimissionCertificateSidList;

    /**
     * 离职证明信息sids
     */
    @TableField(exist = false)
    @ApiModelProperty(value = "离职证明信息sids")
    private List<Long> dimissionCertificateSids;

    /**
     * 离职证明记录号
     */
    @Excel(name = "离职证明记录号")
    @ApiModelProperty(value = "离职证明记录号")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long dimissionCertificateCode;
    ...
    @TableField(exist = false)
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    private String dimissionBeginTime;

    @TableField(exist = false)
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    private String dimissionEndTime;
    ...
    private List<HrDimissionCertificateAttach> attachmentList;
}
