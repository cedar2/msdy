...
/**
 * 采购到货台账-附件对象 s_inv_record_goods_arrival_attach
 *
 * @author linhongwei
 * @date 2022-06-27
 */
...
@ApiModel
@TableName(value = "s_inv_record_goods_arrival_attach")
//@JsonInclude(JsonInclude.Include.NON_NULL)
public class InvRecordGoodsArrivalAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-采购到货台账附件信息")
    private Long goodsArrivalAttachSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] goodsArrivalAttachSidList;
    /**
     * 系统SID-采购到货台账
     */
