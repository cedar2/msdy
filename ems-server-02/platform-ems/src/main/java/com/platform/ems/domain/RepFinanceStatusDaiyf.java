...
/**
 * 财务状况-供应商-待预付对象 s_rep_finance_status_daiyf
 *
 * @author chenkw
 * @date 2022-02-25
 */
...
@ApiModel
@TableName(value = "s_rep_finance_status_daiyf")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RepFinanceStatusDaiyf extends EmsBaseEntity {
     ...
     * 类型：采购合同、采购订单
     */
    @ApiModelProperty(value = "类型：采购合同、采购订单")
    private String statisticType;

    @Excel(name = "类型")
    @TableField(exist = false)
    @ApiModelProperty(value = "类型：销售合同、销售订单")
     ...
     */
    @Excel(name = "待预付金额")
    @ApiModelProperty(value = "待预付金额")
    private BigDecimal moneyAmountDaiyf;
