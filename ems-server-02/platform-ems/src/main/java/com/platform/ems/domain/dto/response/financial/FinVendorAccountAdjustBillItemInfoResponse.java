...
/**
 * 供应商调账单明细详情查询返回实体 FinVendorAccountAdjustBillItemInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
public class FinVendorAccountAdjustBillItemInfoResponse extends EmsBaseEntity implements Serializable {
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "采购发货单sid")
