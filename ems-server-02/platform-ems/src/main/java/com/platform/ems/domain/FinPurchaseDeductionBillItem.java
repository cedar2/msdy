...
/**
 * 采购扣款单-明细对象 s_fin_purchase_deduction_item
 *
 * @author linhongwei
 * @date 2021-04-10
 */
...
@ApiModel
@TableName(value = "s_fin_purchase_deduction_bill_item")
public class FinPurchaseDeductionBillItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-采购扣款单明细")
    private Long purchaseDeductionItemSid;
