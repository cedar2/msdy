...
/**
 * 单据类型_客户押金对象 s_con_doc_type_customer_cash_pledge
 *
 * @author linhongwei
 * @date 2021-09-25
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_customer_cash_pledge")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeCustomerCashPledge extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-单据类型(客户押金)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(客户押金)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(客户押金)名称")
    private String name;
