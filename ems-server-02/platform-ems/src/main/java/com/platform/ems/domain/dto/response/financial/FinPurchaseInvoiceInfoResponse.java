...
/**
 *  采购发票详情数据返回实体 FinPurchaseInvoiceInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
public class FinPurchaseInvoiceInfoResponse extends EmsBaseEntity implements Serializable {
    ...
    private List<FinPurchaseInvoiceItemListResponse> itemList;

    @ApiModelProperty(value = "采购发票-折扣对象")
    private List<FinPurchaseInvoiceDiscountListResponse> discountList;
