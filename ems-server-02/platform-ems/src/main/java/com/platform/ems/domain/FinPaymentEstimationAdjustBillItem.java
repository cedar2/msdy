...
/**
 * 应付暂估调价量单-明细对象 s_fin_payment_estimation_adjust_bill_item
 *
 * @author chenkw
 * @date 2022-01-10
 */
...
@ApiModel
@TableName(value = "s_fin_payment_estimation_adjust_bill_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinPaymentEstimationAdjustBillItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-应付暂估调价量单明细")
    private Long paymentEstimationAdjustBillItemSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] paymentEstimationAdjustBillItemSidList;
    /**
     * 系统SID-应付暂估调价量单
     */
    @Excel(name = "系统SID-应付暂估调价量单")
    @JsonSerialize(using = ToStringSerializer.class)
    ...
    @TableField(exist = false)
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水账（应付暂估）")
