...
/**
 * 供应商注册-附件对象 s_bas_vendor_register_attach
 *
 * @author chenkw
 * @date 2022-02-21
 */
...
@ApiModel
@TableName(value = "s_bas_vendor_register_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BasVendorRegisterAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-供应商注册附件信息")
    private Long vendorRegisterAttachSid;

    @ApiModelProperty(value = "sid数组")
    @TableField(exist = false)
    private Long[] vendorRegisterAttachSidList;
