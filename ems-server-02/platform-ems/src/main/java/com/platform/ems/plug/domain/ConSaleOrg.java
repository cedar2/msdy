...
@ApiModel
@TableName(value = "s_con_sale_org")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConSaleOrg extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-销售组织sid")
    private Long sid;
    ...
    @Length(max = 8, message = "销售组织编码不能超过8个字符")
    @Excel(name = "销售组织编码")
    ...
    @Length(max = 300, message = "销售组织名称不能超过300个字符")
    @Excel(name = "销售组织名称")
