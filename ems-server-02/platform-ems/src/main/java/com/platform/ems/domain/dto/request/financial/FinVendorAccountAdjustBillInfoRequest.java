...
/**
 * 供应商调账单详情请求实体 FinVendorAccountAdjustBillInfoRequest
 *
 * @author chenkaiwen
 * @date 2021-07-26
 */
...
@ApiModel
public class FinVendorAccountAdjustBillInfoRequest extends EmsBaseEntity implements Serializable {
    ...
    private List<FinVendorAccountAdjustBillItemInfoRequest> itemList;
