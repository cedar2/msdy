...
@ApiModel
@TableName(value = "s_pur_inquiry")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PurInquiry extends EmsBaseEntity {
    ...
    @TableField(fill = FieldFill.INSERT)
    @ApiModelProperty(value = "创建时间（用户名称）")
    ...
    @TableField(fill = FieldFill.UPDATE)
    @ApiModelProperty(value = "更新时间（用户名称）")
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "采购模式多选下拉框")
    private String[] purchaseModeList;

    @TableField(exist = false)
    @ApiModelProperty(value = "物料询价单明细对象")
    private List<PurInquiryItem> itemList;

    @TableField(exist = false)
    @ApiModelProperty(value = "物料询价单供应商明细对象")
    private List<PurInquiryVendor> vendorList;

    @TableField(exist = false)
    @ApiModelProperty(value = "物料询价单附件对象")
    private List<PurInquiryAttach> attachmentList;
