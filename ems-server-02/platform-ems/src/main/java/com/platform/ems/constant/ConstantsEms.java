...
public class ConstantsEms {
     ...
     * 加工采购价详情
     */
    public static final String TODO_OUT_PUR_PRICE_MENU_NAME = "加工采购价详情";
    /**
     * 查询类型-销售
     */
     ...
     * 订单明细状态
     */
    public static final String STATUS_CLOSE_STATUS = "GB";

    /**
     * 订单明细状态
     */
    public static final String STATUS_INVALID_STATUS = "ZF";
