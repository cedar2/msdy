...
/**
 * 应收暂估调价量单对象 s_fin_receipt_estimation_adjust_bill
 *
 * @author chenkw
 * @date 2022-01-10
 */
...
@ApiModel
@TableName(value = "s_fin_receipt_estimation_adjust_bill")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinReceiptEstimationAdjustBill extends EmsBaseEntity {
    ...
    private Long[] receiptEstimationAdjustBillSidList;

    /**
     * 应收暂估调价量单号
     */
    @Excel(name = "应收暂估调价量单号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "应收暂估调价量单号")
    private Long receiptEstimationAdjustBillCode;
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "应收暂估调价量单-明细对象")
    private List<FinReceiptEstimationAdjustBillItem> itemList;

    @TableField(exist = false)
    @ApiModelProperty(value = "应收暂估调价量单-附件对象")
    private List<FinReceiptEstimationAdjustBillAttach> attachmentList;

    @TableField(exist = false)
    @ApiModelProperty(value = "系统SID-客户多选下拉框")
