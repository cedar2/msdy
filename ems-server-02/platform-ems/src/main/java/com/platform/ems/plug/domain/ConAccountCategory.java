...
@ApiModel
@TableName(value = "s_con_account_category")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConAccountCategory extends EmsBaseEntity {
     ...
     * 款项类别编码
     */
    @Length(max = 8, message = "款项类别编码不能超过8个字符")
    @NotBlank(message = "款项类别编码不能为空")
    @Excel(name = "款项类别编码")
     ...
     * 款项类别名称
     */
    @Length(max = 300, message = "款项类别名称不能超过300个字符")
    @NotBlank(message = "款项类别名称不能为空")
    @Excel(name = "款项类别名称")
