...
/**
 * 收款单-核销预收明细表对象 s_fin_receivable_bill_item_yushou
 *
 * @author platform
 * @date 2024-03-12
 */
...
@TableName(value = "s_fin_receivable_bill_item_yushou")
public class FinReceivableBillItemYushou extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-收款单核销预收明细")
    private Long receivableBillItemYushouSid;

    @TableField(exist = false)
    private Long[] receivableBillItemYushouSidList;
    ...
    @TableField(exist = false)
    @Excel(name = "处理状态(收款单)", dictType = "s_handle_status")
    @ApiModelProperty(value = "处理状态")
    private String handleStatus;

    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-流水账（预收款）")
    ...
    @Excel(name = "已预收款财务流水号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "流水账编号（预收款）")
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "流水已预收金额（含税）")
