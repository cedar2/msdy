...
/**
 * 财务流水账-明细-供应商扣款对象 s_fin_book_vendor_deduction_item
 *
 * @author linhongwei
 * @date 2021-06-02
 */
...
@ApiModel
@TableName(value = "s_fin_book_vendor_deduction_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FinBookVendorDeductionItem extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-流水账明细（供应商扣款）")
