...
/**
 * 客户扣款单详情查询返回实体 FinCustomerDeductionBillInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
public class FinCustomerDeductionBillInfoResponse extends EmsBaseEntity implements Serializable {
    ...
    private List<FinCustomerDeductionBillItemInfoResponse> itemList;

    @ApiModelProperty(value = "扣款附件")
    private List<FinCustomerDeductionBillAttachment> attachmentList;

    public List<FinCustomerDeductionBillItemInfoResponse> getItemList() {
