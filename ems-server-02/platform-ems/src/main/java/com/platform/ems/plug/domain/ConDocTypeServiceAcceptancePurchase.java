...
/**
 * 单据类型_服务采购验收单对象 s_con_doc_type_service_acceptance_purchase
 *
 * @author chenkw
 * @date 2021-05-20
 */
...
@ApiModel
@TableName(value = "s_con_doc_type_service_acceptance_purchase")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ConDocTypeServiceAcceptancePurchase extends EmsBaseEntity {
    ...
    /**
     * 系统SID-单据类型(服务采购验收单)sid
     */
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-单据类型(服务采购验收单)sid")
    private Long sid;
    ...
    @Excel(name = "单据类型编码")
    @ApiModelProperty(value = "单据类型(服务采购验收单)编码")
    private String code;
    ...
    @Excel(name = "单据类型名称")
    @ApiModelProperty(value = "单据类型(服务采购验收单)名称")
    private String name;
