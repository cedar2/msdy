...
/**
 * 客户调账单明细详情查询请求实体 FinCustomerAccountAdjustBillItemInfoRequest
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
@ApiModel
public class FinCustomerAccountAdjustBillItemInfoRequest extends EmsBaseEntity implements Serializable {
