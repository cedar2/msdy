...
/**
 *  客户调账明细报表 FinVendorAccountAdjustBillItemFormRequest
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
@ApiModel
public class FinCustomerAccountAdjustBillItemFormRequest extends EmsBaseEntity implements Serializable {
