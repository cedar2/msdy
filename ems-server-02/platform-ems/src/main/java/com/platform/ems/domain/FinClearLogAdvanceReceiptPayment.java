...
/**
 * 核销客户已预收款日志对象 s_fin_clear_log_advance_receipt_payment
 *
 * @author platform
 * @date 2024-03-28
 */
...
@TableName(value = "s_fin_clear_log_advance_receipt_payment")
public class FinClearLogAdvanceReceiptPayment extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "客户已预收款单号")
    private Long bookReceivableBillCode;
    ...
    @TableId
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "系统SID-核销客户已预收款日志表")
    private Long clearLogAdvanceReceiptPaymentSid;

    @TableField(exist = false)
    @ApiModelProperty(value = "sid数组")
    private Long[] clearLogAdvanceReceiptPaymentSidList;
     ...
     * 客户已预收款财务流水号
     */
    @Excel(name = "客户已预收款财务流水号")
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "客户已预收款财务流水号")
