...
/**
 * 销售订单-发货计划对象 s_sal_sales_order_delivery_plan
 *
 * @author linhongwei
 * @date 2021-11-01
 */
...
@ApiModel
@TableName(value = "s_sal_sales_order_delivery_plan")
//@JsonInclude(JsonInclude.Include.NON_NULL)
public class SalSalesOrderDeliveryPlan extends EmsBaseEntity{
