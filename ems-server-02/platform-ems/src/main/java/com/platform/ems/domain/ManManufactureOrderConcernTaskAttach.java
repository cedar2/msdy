...
/**
 * 生产订单关注事项-附件对象 s_man_manufacture_order_concern_task_attach
 *
 * @author linhongwei
 * @date 2024-10-11
 */
...
@ApiModel
@TableName(value = "s_man_manufacture_order_concern_task_attach")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ManManufactureOrderConcernTaskAttach extends EmsBaseEntity {
    ...
    @ApiModelProperty(value = "系统SID-生产订单关注事项附件")
