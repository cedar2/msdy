...
/**
 * 客户调账单详情查询返回实体 FinCustomerAccountAdjustBillInfoResponse
 *
 * @author chenkaiwen
 * @date 2021-07-12
 */
...
public class FinCustomerAccountAdjustBillInfoResponse extends EmsBaseEntity implements Serializable {
    ...
    private List<FinCustomerAccountAdjustBillItemInfoResponse> itemList;

    @ApiModelProperty(value = "附件List")
    private List<FinCustomerAccountAdjustBillAttachment> attachmentList;

    public List<FinCustomerAccountAdjustBillItemInfoResponse> getItemList() {
