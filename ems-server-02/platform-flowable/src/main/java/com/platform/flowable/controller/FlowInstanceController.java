...
public class FlowInstanceController {
    ...
    public AjaxResult startById(@ApiParam(value = "流程定义id") @PathVariable(value = "procDefId") String procDefId,
        ...
        return AjaxResult.success(flowInstanceService.startProcessInstanceById(procDefId, variables));
    ...
    public AjaxResult delete(@RequestBody Map<String, Object> variables) {
        flowInstanceService.delete(variables);
        return AjaxResult.success();
    }
}
